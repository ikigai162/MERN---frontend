  ...
  return (
    <Paper classes={{ root: styles.root }}>
      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        {/* se indeplineste doar in cazul in care a fost trimisa forma. handleSubmit va indeplini functia onSubmit doar daca cele doua campuri vor fi corect validate*/}
        <TextField
        ...
        <TextField
          ...
          label="Пароль"
          type="password"
          error={Boolean(errors.password?.message)} //Daca va fi eroare atunci campul va fi iluminat cu rosu
